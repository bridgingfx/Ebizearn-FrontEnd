    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-lg text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-200"
        >
  ...
  return (
    <form onSubmit={submit} className="rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50/60 dark:bg-white/[0.03] p-5 space-y-4">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-500/10 text-[#168BFF] dark:text-blue-300 flex items-center justify-center">
        ...
        <div className="min-h-[1rem]">
          {msg ? (
            ...
            <p className="text-[11px] text-gray-500 dark:text-gray-400">
              ...
              <Link to="/forgot-password" className="font-bold text-[#168BFF] dark:text-blue-300 hover:underline">
                Set one by email
              </Link>
              .
            </p>
