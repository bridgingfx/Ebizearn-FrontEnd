        ...
        <div className="p-6 sm:p-8">
          ...
          {activeTab === 'company' && (
            <form onSubmit={handleSave} className="space-y-6 max-w-3xl">
              <div className="flex flex-col sm:flex-row sm:items-center gap-5 p-4 rounded-2xl bg-gray-50 border border-gray-200">
                <AvatarUploadControl size="lg" showRemove />
                <div>
                  <h3 className="text-sm font-black text-gray-900">Business Profile Photo</h3>
                  <p className="text-xs text-gray-500 mt-1">
                    Used on your account menu and team-facing brand workspace for {user?.business?.company_name || user?.name || 'this account'}.
                  </p>
                </div>
              </div>
