...
/** Several countries share a code (+1, +44, +7…): prefer the main one. */
const PRIMARY_FOR_DIAL: Record<string, string> = { '+1': 'US', '+44': 'GB', '+7': 'RU', '+61': 'AU', '+358': 'FI', '+47': 'NO', '+39': 'IT', '+212': 'MA', '+262': 'RE', '+590': 'GP', '+599': 'CW' };

export const findCountryDialByDial = (dial: string): CountryDial | undefined =>
  (PRIMARY_FOR_DIAL[dial] && findCountryDialByIso(PRIMARY_FOR_DIAL[dial])) || COUNTRY_DIALS.find((c) => c.dial === dial);
